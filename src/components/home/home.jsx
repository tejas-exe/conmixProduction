  ...
  return (
    <Fade easing={"linear"} duration={2000} arrows={false}>
      <Helmet>
        ...
        />
        <meta name="description" content="Conmix RMC Somnath,Surat" />
        <meta name="description" content="Conmix Somnath" />
        <meta name="description" content="Conmix Surat" />
        <meta name="description" content="Conmix RMC Somnath" />
        <meta name="description" content="Conmix RMC Surat" />
        <meta
          name="description"
          content="Provide high-quality ready mix concrete to clients."
        />
        ...
        >
          ...
          >
            ...
            <p className={s.sliderContent}>
              ...
              our expertise elevates your projects to new heights. With a legacy
              of excellence, our ready-mix concrete is more than a building
              material – it's a symbol of reliability and progress. From
              groundbreaking to completion, we stand by your side, ensuring each
              phase of your project embodies the strength and resilience our
      ...
      <div className="each-slide-effect">
        ...
        >
          ...
          >
            ...
            <p className={s.sliderContent}>
              Experience the epitome of strength with our ready-mix concrete – a
              powerhouse of reliability and resilience. Beyond being just a mix,
              our carefully crafted blend defines a new standard in durability.
              From the first pour to the finishing touches, our concrete's
              unmatched power ensures your structures stand the test of time.
              Unleash the strength your projects deserve and build a foundation
              that withstands challenges, embodying the resilience of our
              exceptional ready-mix concrete. Embark on a construction journey
              that redefines strength and resilience with our ready-mix
              concrete. More than a mere blend, it stands as a true powerhouse
              of reliability.
            </p>
          </div>
        </div>
